...
* fix(cropperjs): correct regex for allowed elements and add test for similar tag names ([1158791](https://github.com/fengyuanchen/cropperjs/commit/1158791))
* fix(element-canvas): improve pointer handling and add tests for action defaults ([c5a3378](https://github.com/fengyuanchen/cropperjs/commit/c5a3378))
* fix(element-canvas): refactor pointer handling ([3f9994e](https://github.com/fengyuanchen/cropperjs/commit/3f9994e))
* fix(element-grid): improve grid row handling in CropperGrid rendering ([80c91aa](https://github.com/fengyuanchen/cropperjs/commit/80c91aa))
* fix(element-image): handle null values in attributeChangedCallback for native attributes ([f6cb23f](https://github.com/fengyuanchen/cropperjs/commit/f6cb23f))
* fix(element-selection): scale the selection when triggering a `transform` action on the touchscreen ([8e1c55e](https://github.com/fengyuanchen/cropperjs/commit/8e1c55e)), closes [#1300](https://github.com/fengyuanchen/cropperjs/issues/1300)
* fix(element-viewer): ensure image is removed from shadow DOM on disconnect ([1b28e07](https://github.com/fengyuanchen/cropperjs/commit/1b28e07))
* fix(element): improve readability of supportsAdoptedStyleSheets and attributeChangedCallback ([1ce2dca](https://github.com/fengyuanchen/cropperjs/commit/1ce2dca))
* docs: add link to cropperjs-react-wrapper (#1294) ([2d2a535](https://github.com/fengyuanchen/cropperjs/commit/2d2a535)), closes [#1294](https://github.com/fengyuanchen/cropperjs/issues/1294)
* docs: fix eslint errors ([25e14e7](https://github.com/fengyuanchen/cropperjs/commit/25e14e7))
* docs: update cropper-crosshair component syntax for self-closing tag ([6f40df5](https://github.com/fengyuanchen/cropperjs/commit/6f40df5))
* docs: update README and migration documentation for clarity and accuracy ([782b8ea](https://github.com/fengyuanchen/cropperjs/commit/782b8ea))
* docs(cropper-image): add example of limiting initial centered size ([9193a77](https://github.com/fengyuanchen/cropperjs/commit/9193a77))
* docs(cropper-image): fix the casing of the `initialCenterSize` property ([815bd9d](https://github.com/fengyuanchen/cropperjs/commit/815bd9d))
* docs(element-image): use default max/min fit value in the playground ([4e273fb](https://github.com/fengyuanchen/cropperjs/commit/4e273fb))
* ci: restrict tag pattern to v2.* for npm publish and release workflows ([f87d377](https://github.com/fengyuanchen/cropperjs/commit/f87d377))
* chore: update dependencies to latest versions ([edd5c3d](https://github.com/fengyuanchen/cropperjs/commit/edd5c3d))
* chore: update stylelint configuration to allow empty input ([fc8254a](https://github.com/fengyuanchen/cropperjs/commit/fc8254a))
* build: replace husky with simple-git-hooks for Git hooks management ([e9e08ea](https://github.com/fengyuanchen/cropperjs/commit/e9e08ea))
* test: fix test cases ([8e597a3](https://github.com/fengyuanchen/cropperjs/commit/8e597a3))
* feat(cropper-image): add "fill", "scale-down", and "none" options to the `$center` method ([2a97f8c](https://github.com/fengyuanchen/cropperjs/commit/2a97f8c))
* feat(cropper-image): add the `change` event ([1edbc4f](https://github.com/fengyuanchen/cropperjs/commit/1edbc4f))
* feat(cropper-image): add the `initialFit` property, and deprecate the `initialCenterSize` property ([194338e](https://github.com/fengyuanchen/cropperjs/commit/194338e))
* feat(cropper-image): add the `maxFit` and `minFit` properties ([ad83d7c](https://github.com/fengyuanchen/cropperjs/commit/ad83d7c))
* feat(element-canvas): enable support for preventing the default action in `action` events ([85d7b02](https://github.com/fengyuanchen/cropperjs/commit/85d7b02))
* feat(element-image): support center-based scaling ([e6d2a23](https://github.com/fengyuanchen/cropperjs/commit/e6d2a23))
* feat(element-selection): support center-based scaling ([63d2c82](https://github.com/fengyuanchen/cropperjs/commit/63d2c82))
* style: sort imports ([7ce0e54](https://github.com/fengyuanchen/cropperjs/commit/7ce0e54))
* perf(cropper-image): drop image clone for better performance ([13e6166](https://github.com/fengyuanchen/cropperjs/commit/13e6166))



## <small>2.1.1 (2026-04-06)</small>

* build: release 2.1.1 ([0bbb4de](https://github.com/fengyuanchen/cropperjs/commit/0bbb4de))
* fix(element-image): always center the image, even if it is neither translatable nor scalable ([89fe431](https://github.com/fengyuanchen/cropperjs/commit/89fe431)), closes [#1292](https://github.com/fengyuanchen/cropperjs/issues/1292)
...
* ci: add workflow for publishing package to npm ([f61210c](https://github.com/fengyuanchen/cropperjs/commit/f61210c))
