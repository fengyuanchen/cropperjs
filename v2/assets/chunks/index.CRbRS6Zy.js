const lt=typeof window<"u"&&typeof window.document<"u",x=lt?window:{},wt=lt?"ontouchstart"in x.document.documentElement:!1,Ct=lt?"PointerEvent"in x:!1,D="cropper",U=`${D}-canvas`,he=`${D}-crosshair`,ce=`${D}-grid`,le=`${D}-handle`,X=`${D}-image`,I=`${D}-selection`,de=`${D}-shade`,ue=`${D}-viewer`,Q="select",ie="move",Y="scale",ut="rotate",tt="transform",P="none",kt="n-resize",Ot="e-resize",Nt="s-resize",Rt="w-resize",j="ne-resize",B="nw-resize",q="se-resize",Z="sw-resize",$e="action",fe=wt?"touchend touchcancel":"mouseup",ge=wt?"touchmove":"mousemove",me=wt?"touchstart":"mousedown",xt=Ct?"pointerdown":me,It=Ct?"pointermove":ge,_t=Ct?"pointerup pointercancel":fe,Pt="error",Mt="keydown",L="load",Ue="resize",Dt="wheel",H="action",z="actionend",pe="actionmove",W="actionstart",M="change",$t="transform";function G(l){return typeof l=="string"}const ne=Number.isNaN||x.isNaN;function $(l){return typeof l=="number"&&!ne(l)}function T(l){return $(l)&&l>0&&l<1/0}function be(l){return typeof l>"u"}function ae(l){return typeof l=="object"&&l!==null}const{hasOwnProperty:Ee}=Object.prototype;function et(l){if(!ae(l))return!1;try{const{constructor:t}=l,{prototype:s}=t;return t&&s&&Ee.call(s,"isPrototypeOf")}catch{return!1}}function yt(l){return typeof l=="function"}function F(l){return typeof l=="object"&&l!==null&&l.nodeType===1}const ve=/([a-z\d])([A-Z])/g;function zt(l){return String(l).replace(ve,"$1-$2").toLowerCase()}const Se=/-[A-z\d]/g;function Wt(l){return l.replace(Se,t=>t.slice(1).toUpperCase())}const oe=/\s\s*/;function v(l,t,s,e){t.trim().split(oe).forEach(i=>{l.removeEventListener(i,s,e)})}function S(l,t,s,e){t.trim().split(oe).forEach(i=>{l.addEventListener(i,s,e)})}function Lt(l,t,s,e){S(l,t,s,{...e,once:!0})}const we={bubbles:!0,cancelable:!0,composed:!0};function Ce(l,t,s,e){return l.dispatchEvent(new CustomEvent(t,{...we,detail:s,...e}))}const Xt=Promise.resolve();function ye(l,t){return t?Xt.then(l?t.bind(l):t):Xt}function Yt(l){const{documentElement:t}=l.ownerDocument,s=l.getBoundingClientRect();return{left:s.left+(x.pageXOffset-t.clientLeft),top:s.top+(x.pageYOffset-t.clientTop)}}const Ae=/deg|g?rad|turn$/i;function dt(l){const t=parseFloat(l)||0;if(t!==0){const[s="rad"]=String(l).match(Ae)||[];switch(s.toLowerCase()){case"deg":return t/360*(Math.PI*2);case"grad":return t/400*(Math.PI*2);case"turn":return t*(Math.PI*2)}}return t}const Ht="contain",Te="cover";function J(l,t=Ht){const{aspectRatio:s}=l;let{width:e,height:i}=l;const n=T(e),r=T(i);if(n&&r){const a=i*s;t===Ht&&a>e||t===Te&&a<e?i=e/s:e=i*s}else n?i=e/s:r&&(e=i*s);return{width:e,height:i}}function re(l,...t){if(t.length===0)return l;const[s,e,i,n,r,a]=l,[c,h,o,u,f,g]=t[0];return l=[s*c+i*h,e*c+n*h,s*o+i*u,e*o+n*u,s*f+i*g+r,e*f+n*g+a],re(l,...t.slice(1))}const ke=`
:host([hidden]) {
  display: none !important;
}
`,Oe=/left|top|width|height/i,Ut="open",K=new WeakMap,V=new WeakMap,jt=new Map,Bt=x.document&&Array.isArray(x.document.adoptedStyleSheets)&&"replaceSync"in x.CSSStyleSheet.prototype,At=class At extends HTMLElement{constructor(){var s,e;super(),this.shadowRootMode=Ut,this.slottable=!0;const t=(e=(s=Object.getPrototypeOf(this))==null?void 0:s.constructor)==null?void 0:e.$name;t&&jt.set(t,this.tagName.toLowerCase())}get $sharedStyle(){return`${this.themeColor?`:host{--theme-color: ${this.themeColor};}`:""}${ke}`}static get observedAttributes(){return["shadow-root-mode","slottable","theme-color"]}attributeChangedCallback(t,s,e){if(Object.is(e,s))return;const i=Wt(t),n=this[i];let r=e;switch(typeof n){case"boolean":r=e!==null&&e!=="false";break;case"number":r=Number(e);break}switch(this[i]=r,t){case"theme-color":{const a=V.get(this),c=this.$sharedStyle;a&&c&&(Bt?a.replaceSync(c):a.textContent=c);break}}}$propertyChangedCallback(t,s,e){if(!Object.is(e,s))switch(t=zt(t),typeof e){case"boolean":e===!0?this.hasAttribute(t)||this.setAttribute(t,""):this.removeAttribute(t);break;case"number":ne(e)?e="":e=String(e);default:e?this.getAttribute(t)!==e&&this.setAttribute(t,e):this.removeAttribute(t)}}connectedCallback(){Object.getPrototypeOf(this).constructor.observedAttributes.forEach(s=>{const e=Wt(s);let i=this[e];be(i)||this.$propertyChangedCallback(e,void 0,i),Object.defineProperty(this,e,{enumerable:!0,configurable:!0,get(){return i},set(n){const r=i;i=n,this.$propertyChangedCallback(e,r,n)}})});const t=this.attachShadow({mode:this.shadowRootMode||Ut});if(this.shadowRoot||K.set(this,t),V.set(this,this.$addStyles(this.$sharedStyle)),this.$style&&this.$addStyles(this.$style),this.$template){const s=document.createElement("template");s.innerHTML=this.$template,t.appendChild(s.content)}if(this.slottable){const s=document.createElement("slot");t.appendChild(s)}}disconnectedCallback(){V.has(this)&&V.delete(this),K.has(this)&&K.delete(this)}$getTagNameOf(t){return jt.get(t)??t}$setStyles(t){return Object.keys(t).forEach(s=>{let e=t[s];$(e)&&(e!==0&&Oe.test(s)?e=`${e}px`:e=String(e)),this.style[s]=e}),this}$getShadowRoot(){return this.shadowRoot||K.get(this)}$addStyles(t){let s;const e=this.$getShadowRoot();return Bt?(s=new CSSStyleSheet,s.replaceSync(t),e.adoptedStyleSheets=e.adoptedStyleSheets.concat(s)):(s=document.createElement("style"),s.textContent=t,e.appendChild(s)),s}$emit(t,s,e){return Ce(this,t,s,e)}$nextTick(t){return ye(this,t)}static $define(t,s){ae(t)&&(s=t,t=""),t||(t=this.$name||this.name),t=zt(t),lt&&x.customElements&&!x.customElements.get(t)&&customElements.define(t,this,s)}};At.$version="__VERSION__";let _=At;const Ne=`
:host {
  display: block;
  min-height: 100px;
  min-width: 200px;
