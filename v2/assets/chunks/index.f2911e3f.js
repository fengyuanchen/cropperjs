...
`,Wt=new WeakMap;class $t extends R{constructor(){super(...arguments),this.$onCanvasAction=null,this.$onCanvasActionStart=null,this.$onCanvasActionEnd=null,this.$onDocumentKeyDown=null,this.$actionStartTarget=null,this.$style=ve,this.x=0,this.y=0,this.width=0,this.height=0,this.aspectRatio=NaN,this.initialAspectRatio=NaN,this.initialCoverage=NaN,this.active=!1,this.movable=!1,this.resizable=!1,this.zoomable=!1,this.multiple=!1,this.keyboard=!1,this.outlined=!1,this.precise=!1}set $canvas(t){Wt.set(this,t)}get $canvas(){return Wt.get(this)}static get observedAttributes(){return super.observedAttributes.concat(["active","aspect-ratio","height","initial-aspect-ratio","initial-coverage","keyboard","movable","multiple","outlined","precise","resizable","width","x","y","zoomable"])}$propertyChangedCallback(t,s,e){if(!Object.is(e,s))switch(super.$propertyChangedCallback(t,s,e),t){case"aspectRatio":T(e)||(this.aspectRatio=NaN);break;case"initialAspectRatio":T(e)||(this.initialAspectRatio=NaN);break;case"initialCoverage":(!T(e)||e>1)&&(this.initialCoverage=NaN);break;case"keyboard":this.$nextTick(()=>{this.$canvas&&(e?this.$onDocumentKeyDown||(this.$onDocumentKeyDown=this.$handleKeyDown.bind(this),v(this.ownerDocument,At,this.$onDocumentKeyDown)):this.$onDocumentKeyDown&&(C(this.ownerDocument,At,this.$onDocumentKeyDown),this.$onDocumentKeyDown=null))});break;case"multiple":this.$nextTick(()=>{this.$canvas&&(e?this.active=!0:(this.$getSelections().forEach((i,n)=>{n>0&&this.$removeSelection(i)}),this.active=!1))});break}}connectedCallback(){super.connectedCallback(),this.multiple&&!this.active&&(this.active=!0);const t=this.closest(this.$getTagNameOf(H));if(t){this.$canvas=t,this.$setStyles({position:"absolute",transform:`translate(${this.x}px, ${this.y}px)`}),this.hidden||this.$render();const{initialCoverage:s,parentElement:e}=this;if(T(s)&&e){const i=this.aspectRatio||this.initialAspectRatio,{offsetWidth:n,offsetHeight:c}=e;let o=n*s,h=c*s;T(i)&&({width:o,height:h}=J({aspectRatio:i,width:o,height:h})),this.$change(this.x,this.y,o,h),this.$center()}this.$onCanvasActionStart=this.$handleActionStart.bind(this),this.$onCanvasActionEnd=this.$handleActionEnd.bind(this),this.$onCanvasAction=this.$handleAction.bind(this),v(t,L,this.$onCanvasActionStart),v(t,z,this.$onCanvasActionStart),v(t,Y,this.$onCanvasAction)}else this.$render()}disconnectedCallback(){const{$canvas:t}=this;t&&(this.$onCanvasActionStart&&(C(t,L,this.$onCanvasActionStart),this.$onCanvasActionStart=null),this.$onCanvasActionEnd&&(C(t,z,this.$onCanvasActionEnd),this.$onCanvasActionEnd=null),this.$onCanvasAction&&(C(t,Y,this.$onCanvasAction),this.$onCanvasAction=null)),super.disconnectedCallback()}$getSelections(){let t=[];return this.parentElement&&(t=Array.from(this.parentElement.querySelectorAll(this.$getTagNameOf(D)))),t}$createSelection(){const t=this.cloneNode(!0);return this.hasAttribute("id")&&t.removeAttribute("id"),this.active=!1,this.parentElement&&this.parentElement.insertBefore(t,this.nextSibling),t}$removeSelection(t=this){if(this.parentElement){const s=this.$getSelections();if(s.length>1){const e=s.indexOf(t),i=s[e+1]||s[e-1];i&&(t.active=!1,this.parentElement.removeChild(t),i.active=!0,i.$emit(M,{x:i.x,y:i.y,width:i.width,height:i.height}))}else this.$reset(),this.hidden=!0}}$handleActionStart(t){var e,i;const s=(i=(e=t.detail)==null?void 0:e.relatedEvent)==null?void 0:i.target;this.$actionStartTarget=s,!this.hidden&&this.multiple&&!this.active&&s===this&&this.parentElement&&(this.$getSelections().forEach(n=>{n.active=!1}),this.active=!0,this.$emit(M,{x:this.x,y:this.y,width:this.width,height:this.height}))}$handleAction(t){if(this.multiple&&!this.active)return;const{currentTarget:s,detail:e}=t;if(s&&e){const{relatedEvent:i}=e;let{action:n}=e;if(!n&&this.multiple&&(n=i==null?void 0:i.target.action),!n||this.hidden&&n!==Q)return;const c=e.endX-e.startX,o=e.endY-e.startY,{width:h,height:r}=this;let{aspectRatio:a}=this;switch(!T(a)&&t.shiftKey&&(a=T(h)&&T(r)?h/r:1),n){case Q:{const{$canvas:d}=this,f=It(s);(this.multiple&&!this.hidden?this.$createSelection():this).$change(e.startX-f.left,e.startY-f.top,c,o,a),n=j,c<0?o>0?n=q:o<0&&(n=B):c>0&&o<0&&(n=U),d&&(d.$action=n);break}case jt:this.movable&&this.$actionStartTarget&&this.contains(this.$actionStartTarget)&&this.$move(c,o);break;case F:if(i&&this.zoomable){const d=It(s);this.$zoom(e.scale,i.pageX-d.left,i.pageY-d.top)}break;default:this.$resize(n,c,o,a)}}}$handleActionEnd(){this.$actionStartTarget=null}$handleKeyDown(t){if(!(this.hidden||!this.keyboard||this.multiple&&!this.active||t.defaultPrevented))switch(t.key){case"Backspace":t.metaKey&&(t.preventDefault(),this.$removeSelection());break;case"Delete":t.preventDefault(),this.$removeSelection();break;case"ArrowLeft":t.preventDefault(),this.$move(-1,0);break;case"ArrowRight":t.preventDefault(),this.$move(1,0);break;case"ArrowUp":t.preventDefault(),this.$move(0,-1);break;case"ArrowDown":t.preventDefault(),this.$move(0,1);break;case"+":t.preventDefault(),this.$zoom(.1);break;case"-":t.preventDefault(),this.$zoom(-.1);break}}$center(){const{parentElement:t}=this;if(!t)return this;const s=(t.offsetWidth-this.width)/2,e=(t.offsetHeight-this.height)/2;return this.$change(s,e)}$move(t,s=t){return this.$moveTo(this.x+t,this.y+s)}$moveTo(t,s=t){return this.movable?this.$change(t,s):this}$resize(t,s=0,e=0,i=this.aspectRatio){if(!this.resizable)return this;const n=T(i),{$canvas:c}=this;let{x:o,y:h,width:r,height:a}=this;switch(t){case mt:h+=e,a-=e,a<0&&(t=Et,a=-a,h-=a),n&&(s=e*i,o+=s/2,r-=s,r<0&&(r=-r,o-=r));break;case bt:r+=s,r<0&&(t=Ct,r=-r,o-=r),n&&(e=s/i,h-=e/2,a+=e,a<0&&(a=-a,h-=a));break;case Et:a+=e,a<0&&(t=mt,a=-a,h-=a),n&&(s=e*i,o-=s/2,r+=s,r<0&&(r=-r,o-=r));break;case Ct:o+=s,r-=s,r<0&&(t=bt,r=-r,o-=r),n&&(e=s/i,h+=e/2,a-=e,a<0&&(a=-a,h-=a));break;case U:n&&(e=-s/i),h+=e,a-=e,r+=s,r<0&&a<0?(t=q,r=-r,a=-a,o-=r,h-=a):r<0?(t=B,r=-r,o-=r):a<0&&(t=j,a=-a,h-=a);break;case B:n&&(e=s/i),o+=s,h+=e,r-=s,a-=e,r<0&&a<0?(t=j,r=-r,a=-a,o-=r,h-=a):r<0?(t=U,r=-r,o-=r):a<0&&(t=q,a=-a,h-=a);break;case j:n&&(e=s/i),r+=s,a+=e,r<0&&a<0?(t=B,r=-r,a=-a,o-=r,h-=a):r<0?(t=q,r=-r,o-=r):a<0&&(t=U,a=-a,h-=a);break;case q:n&&(e=-s/i),o+=s,r-=s,a+=e,r<0&&a<0?(t=U,r=-r,a=-a,o-=r,h-=a):r<0?(t=j,r=-r,o-=r):a<0&&(t=B,a=-a,h-=a);break}return c&&c.$setAction(t),this.$change(o,h,r,a)}$zoom(t,s,e){if(!this.zoomable||t===0)return this;t<0?t=1/(1-t):t+=1;const{width:i,height:n}=this,c=i*t,o=n*t;let h=this.x,r=this.y;return u(s)&&u(e)?(h-=(c-i)*((s-this.x)/i),r-=(o-n)*((e-this.y)/n)):(h-=(c-i)/2,r-=(o-n)/2),this.$change(h,r,c,o)}$change(t,s,e=this.width,i=this.height,n=this.aspectRatio){return!u(t)||!u(s)||!u(e)||!u(i)?this:(this.precise||(t=Math.round(t),s=Math.round(s),e=Math.round(e),i=Math.round(i)),t===this.x&&s===this.y&&e===this.width&&i===this.height?this:(this.hidden&&(this.hidden=!1),T(n)&&({width:e,height:i}=J({aspectRatio:n,width:e,height:i},"cover")),this.$emit(M,{x:t,y:s,width:e,height:i})===!1?this:(this.x=t,this.y=s,this.width=e,this.height=i,this.$render())))}$reset(){return this.$change(0,0,0,0)}$render(){return this.$setStyles({transform:`translate(${this.x}px, ${this.y}px)`,width:this.width,height:this.height})}$toCanvas(t){return new Promise((s,e)=>{if(!this.isConnected){e(new Error("The current element is not connected to the DOM."));return}const i=document.createElement("canvas");let{width:n,height:c}=this,o=1;if(et(t)&&(T(t.width)||T(t.height))&&({width:n,height:c}=J({aspectRatio:n/c,width:t.width,height:t.height}),o=n/this.width),i.width=n,i.height=c,!this.$canvas){s(i);return}const h=this.$canvas.querySelector(this.$getTagNameOf(X));if(!h){s(i);return}h.$ready().then(r=>{const a=i.getContext("2d");if(a){const[d,f,p,$,y,S]=h.$getTransform(),b=-this.x,E=-this.y,g=(b*$-p*E)/(d*$-p*f),m=(E-f*g)/$;let w=d*g+p*m+y,A=f*g+$*m+S,k=r.naturalWidth,_=r.naturalHeight;o!==1&&(w*=o,A*=o,k*=o,_*=o);const N=k/2,O=_/2;a.fillStyle="transparent",a.fillRect(0,0,n,c),et(t)&&ct(t.beforeDraw)&&t.beforeDraw.call(this,a,i),a.save(),a.translate(N,O),a.transform(d,f,p,$,w,A),a.translate(-N,-O),a.drawImage(r,0,0,k,_),a.restore()}s(i)}).catch(e)})}}$t.$name=D;$t.$version="__VERSION__";const Se=`
:host {
  display: flex;
