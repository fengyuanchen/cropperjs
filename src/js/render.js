  extend(prototype, {
    ...
    limitCropBox: function (size, position) {
      ...
      if (size) {
        ...
        maxCropBoxWidth = min(containerWidth, this.limited ? canvasData.width : containerWidth);
        maxCropBoxHeight = min(containerHeight, this.limited ? canvasData.height : containerHeight);
